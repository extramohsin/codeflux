        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Igniting the spark of innovation in young minds through hands-on technology education. 
              Building the future, one student at a time across Maharashtra.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#workshops" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Workshops
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 CodeFlux. All rights reserved. Made with ❤️ for students everywhere.
            </p>
